...
<body>
	...
	<section id="main-content">
		...
		<article>
			<header>
				<h1 id="tituloCurso">FRANCÉS PARA PRINCIPIANTES</h1>
			...
			<div class="content" style="text-align: justify;">
				<p class="decorate"><b>Descripcion</b></p><p>Con el curso de Francés aprenderás los conceptos básicos y fundamentales del idioma francés. Se trata de un curso en el que lograrás adquirir las habilidades necesarias para hablar francés en situaciones cotidianas.<br>
				El curso de francés de Informa&Forma-T, es el mejor curso de francés para principiantes que puedes hacer, ya que las lecciones van aumentando en dificultad progresivamente, además de que en cada lección podrás escuchar la pronunciación en francés de todas las palabras que vayan apareciendo.</p>
				...
				<p class="decorate"><b>Objetivos</b></p><p>Lograrás adquirir las habilidades necesarias para hablar francés en situaciones cotidianas.</p>
				...
				<p class="decorate"><b>Temario</b></p>
					<ol>
						...
						<li>La Nourriture: Gastronomía</li>
						<li>Adjectifs possesifs: Adjetivos Posesivos</li>
						<li>Les Metiers: Oficios</li>
						<li>Y todo lo necesario para desenvolverte en tu día a día</li>
					</ol>
