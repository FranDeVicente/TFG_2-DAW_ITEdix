...
<head>
    ...
    <title>CURSOS | Informa&Forma-T</title>
...
<body>
	...
	<section id="main-content">
		...
		<article>
			<header>
				<h1 id="tituloCurso">NUESTROS CURSOS</h1>
			</header>
			
			
			<div class="content" style="text-align: justify;">
				<p><b>${sessionScope.userName}, aquí puedes escoger el curso que más te interese</b></p>
			<form action="Login?opcion=mostrarCursos" method="post">
					<select name="tipo">
				...
				<a type="button" href="idiomas.jsp">Volver</a>
			</form>
			</div>
