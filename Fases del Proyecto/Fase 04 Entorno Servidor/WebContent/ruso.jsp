	...
	<section id="main-content">
		...
		<article>
			...
			<div class="content" style="text-align: justify;">
				<p class="decorate"><b>Descripcion</b></p><p>Bienvenido/a!... al Curso de Ruso donde podrás aprender este conocido idioma extendido por todo el planeta y tan importante para la vida diaria tanto en el mundo laboral como social.
					Aprenderlo es cuestión de tiempo, paciencia, motivación y voluntad.
					Una de las claves para aprender ruso ( o cualquier idioma ) es la repetición verbal de lo que aprendes, escuchar el idioma ( aunque no lo entiendas ) y repetir una y otra vez las palabras, las frases, hasta que se te quede en la memoria.....
				...
				<p class="decorate"><b>Destinado a</b></p><p>Personas sin ningún tipo de conocimiento en el idioma, que necesite desenvolverse en una conversación profesional como coloquial.</p>
				<p class="decorate"><b>Objetivos</b></p><p>Saber desenvolverse en el ámbito laboral y social.</p>
				...
				<p class="decorate"><b>Temario</b></p><p>Con los temas multimedia aprendemos de forma práctica y sencilla el vocabulario esencial para entender a los ruso hablantes. Con los temas y ejercicios confirmamos y repasamos. Con el tema de Gramática profundizamos.<br><br><b id="tituloCurso">Vocabulario, Ejercicios y Pronunciación</b>
					<ol>
					  <li>Números, colores, palabras cortas</li>
					  <li>Verbos</li>
					  <li>Frases</li>
					  <li>Pronombres</li>
					  <li>Vocabulario</li>
